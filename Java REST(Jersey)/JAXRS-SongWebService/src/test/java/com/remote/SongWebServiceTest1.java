...
public class SongWebServiceTest1 extends JerseyTest {
	
	private static final String URL_RESOURCE = "http://ec2-52-28-238-199.eu-central-1.compute.amazonaws.com:8080/JAXRS-SongWebService/rest/";
	private static final String create_service = "/songwebservice/create";
	private static final String delete_service = "/songwebservice/delete";
	private static final String update_service = "/songwebservice/update";
	private static final String search_service = "/songwebservice/search";
	private static final String searchAll_service = "/songwebservice/searchAll";
	private static final String getAlbumId_service = "/songwebservice/album/";
	...
	@Test
	public void testCreate2() throws JSONException,
			URISyntaxException {
	...
	public void testSearchAll() {
		WebResource webResource = client().resource(URL_RESOURCE);
		ClientResponse responseMsg = webResource.path(searchAll_service).get(ClientResponse.class);
		List<Song>  songlist = responseMsg.getEntity(new GenericType<List<Song>>() {});
